...
namespace ZombieParty.Controllers
{
    ...
    {
        private ZombiePartyDbContext _context { get; set; }

        public ZombieTypeController(ZombiePartyDbContext baseDonnees)
        {
            _context = baseDonnees;
        }

        public IActionResult Index()
        {
            List<ZombieType> zombieTypesList = _context.ZombieTypes.ToList();
        ...
        {
            var zombies = _context.Zombies.Where(z => z.ZombieTypeId == id);
            ...
            zombieTypeVM.ZombieType = _context.ZombieTypes.FirstOrDefault(zt => zt.Id == id);
        ...
        public IActionResult Create(Models.ZombieType zombieType)
        {
            ...
            {
                // Ajouter à la BD
                _context.ZombieTypes.Add(zombieType);
