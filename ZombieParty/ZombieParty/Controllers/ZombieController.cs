...
namespace ZombieParty.Controllers
{
    public class ZombieController : Controller
    {
        ...
        {
            List<Zombie> zombiesList = _context.Zombies.ToList();
        ...
        public IActionResult Create()
        {
            ...
            zombieVM.ZombieTypeSelectList = new SelectList(_context.ZombieTypes.ToList(), "Id", "TypeName");
        ...
        public IActionResult Create(ZombieVM zombieVM)
        {
            ...
            {
                _context.Zombies.Add(zombieVM.Zombie);
